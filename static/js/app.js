;$(function () {
    ...
    var showAddProductPopup = function () {
        ...
        var category = product.find('.category').text();
        $('#addProductPopup .category').text(category);

        var producer = product.find('.producer').text();
        $('#addProductPopup .producer').text(producer);
        ...
        setTimeout(function () {
            ...
            if (data.totalCount === 0) {
                ...
                if (remCount === prevCount) {
                    ...
                    // fix bug| implementation without server part, otherwise, shopping cart returns from server
